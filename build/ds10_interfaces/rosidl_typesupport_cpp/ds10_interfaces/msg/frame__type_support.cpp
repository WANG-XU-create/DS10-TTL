...
static const _Frame_type_support_symbol_names_t _Frame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ds10_interfaces, msg, Frame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ds10_interfaces, msg, Frame)),
  }
};
...
{
  return &::ds10_interfaces::msg::rosidl_typesupport_cpp::Frame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ds10_interfaces, msg, Frame)() {
  return get_message_type_support_handle<ds10_interfaces::msg::Frame>();
}
