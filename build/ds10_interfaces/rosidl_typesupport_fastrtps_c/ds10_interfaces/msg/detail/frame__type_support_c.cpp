...
#include "ds10_interfaces/msg/detail/frame__rosidl_typesupport_fastrtps_c.h"
...
#include "ds10_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ds10_interfaces
...
using _Frame__ros_msg_type = ds10_interfaces__msg__Frame;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tx_seq
  {
    cdr << ros_message->tx_seq;
  }

  // Field name: rx_seq
  {
    cdr << ros_message->rx_seq;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ds10_interfaces
size_t get_serialized_size_ds10_interfaces__msg__Frame(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Frame__ros_msg_type * ros_message = static_cast<const _Frame__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name tx_seq
  {
    size_t item_size = sizeof(ros_message->tx_seq);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name rx_seq
  {
    size_t item_size = sizeof(ros_message->rx_seq);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Frame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ds10_interfaces__msg__Frame(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ds10_interfaces
size_t max_serialized_size_ds10_interfaces__msg__Frame(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ds10_interfaces__msg__Frame;
    is_plain =
      (
      offsetof(DataType, rx_seq) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Frame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ds10_interfaces__msg__Frame(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds10_interfaces, msg, Frame)() {
