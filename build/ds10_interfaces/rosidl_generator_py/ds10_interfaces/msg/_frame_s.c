...
bool ds10_interfaces__msg__frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ds10_interfaces.msg._frame.Frame", full_classname_dest, 32) == 0);
  }
  ds10_interfaces__msg__Frame * ros_message = _ros_message;
  {  // header
  ...
  {  // station_id
    ...
    ros_message->station_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // function_code
  ...
  {  // tx_seq
    PyObject * field = PyObject_GetAttrString(_pymsg, "tx_seq");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tx_seq = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // rx_seq
    PyObject * field = PyObject_GetAttrString(_pymsg, "rx_seq");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->rx_seq = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * ds10_interfaces__msg__frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ds10_interfaces.msg._frame");
  ...
  {  // tx_seq
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->tx_seq);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tx_seq", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // rx_seq
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->rx_seq);
    {
      int rc = PyObject_SetAttrString(_pymessage, "rx_seq", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
