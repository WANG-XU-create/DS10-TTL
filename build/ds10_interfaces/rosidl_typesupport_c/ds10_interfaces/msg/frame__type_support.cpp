...
static const _Frame_type_support_symbol_names_t _Frame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ds10_interfaces, msg, Frame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ds10_interfaces, msg, Frame)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ds10_interfaces, msg, Frame)() {
  return &::ds10_interfaces::msg::rosidl_typesupport_c::Frame_message_type_support_handle;
}
